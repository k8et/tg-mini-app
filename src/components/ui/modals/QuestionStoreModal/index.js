            ...
            {isOpenModal && (
                ...
                >
                    <div className={"bg-[#181818] rounded-[10px] p-3"}>
                        <h1 className={"text-[18px]"}>Магазин</h1>
                        <p className={"text-[14px] text-[#D7D7D799]/40 leading-[14px]"}>Lorem ipsum dolor sit amet,
                            consectetur adipisicing elit. Blanditiis culpa deserunt enim, et eveniet exercitationem
                            illum inventore iste laborum nesciunt perferendis placeat provident quo quos repudiandae
                            rerum tempore totam voluptas!</p>
...
export default QuestionStoreModal;
